...
#######################################################################################
#
# Análisis estadiscico de la evolución del número de fallecidos en cada año
#
#######################################################################################
...
print(" Covarianza")
print("**************************************")
covarianza = data.cov()["Anno"]["Acumulado"]
...
print("**************************************")
pearson = data.corr(method="pearson")["Anno"]["Acumulado"]
print("Coeficiente de Correlacion de Pearson %f" % pearson)

m, b = np.polyfit(data["Anno"], data["Acumulado"], 1)
plt.scatter(data["Anno"], data["Acumulado"])
plt.xlabel("Fecha")
