...
#######################################################################################
#
# Análisis estadiscico de la evolución de la media de fallecidos en cada año
#
#######################################################################################
...
print(" Covarianza")
print("**************************************")
covarianza = data.cov()["Anno"]["Media"]
...
print("**************************************")
pearson = data.corr(method="pearson")["Anno"]["Media"]
print("Coeficiente de Correlacion de Pearson %f" % pearson)

m, b = np.polyfit(data["Anno"], data["Media"], 1)
plt.scatter(data["Anno"], data["Media"])
plt.xlabel("Fecha")
plt.ylabel("Media")
